...
class Child
{
    ...
    private $geoLocations;
        ...
        public function getAuthorizedContacts() { return $this->authorizedContacts; }
        public function addAuthorizedContact(AuthorizedContact $c): self
        { if(!$this->authorizedContacts->contains($c)){ $this->authorizedContacts->add($c); $c->setChild($this);} return $this; }
        public function removeAuthorizedContact(AuthorizedContact $c): self
        { if($this->authorizedContacts->removeElement($c) && $c->getChild()===$this){ $c->setChild(null);} return $this; }

        /** @return \Doctrine\Common\Collections\Collection<int, AuthorizedApp> */
        public function getAuthorizedApps() { return $this->authorizedApps; }
        public function addAuthorizedApp(AuthorizedApp $a): self
        { if(!$this->authorizedApps->contains($a)){ $this->authorizedApps->add($a); $a->setChild($this);} return $this; }
        public function removeAuthorizedApp(AuthorizedApp $a): self
        { if($this->authorizedApps->removeElement($a) && $a->getChild()===$this){ $a->setChild(null);} return $this; }

        /** @return \Doctrine\Common\Collections\Collection<int, FeatureAccess> */
        public function getFeatureAccesses() { return $this->featureAccesses; }
        public function addFeatureAccess(FeatureAccess $f): self
        { if(!$this->featureAccesses->contains($f)){ $this->featureAccesses->add($f); $f->setChild($this);} return $this; }
        public function removeFeatureAccess(FeatureAccess $f): self
        { if($this->featureAccesses->removeElement($f) && $f->getChild()===$this){ $f->setChild(null);} return $this; }

        /** @return \Doctrine\Common\Collections\Collection<int, EmergencyContact> */
        public function getEmergencyContacts() { return $this->emergencyContacts; }
        public function addEmergencyContact(EmergencyContact $e): self
        { if(!$this->emergencyContacts->contains($e)){ $this->emergencyContacts->add($e); $e->setChild($this);} return $this; }
        public function removeEmergencyContact(EmergencyContact $e): self
        { if($this->emergencyContacts->removeElement($e) && $e->getChild()===$this){ $e->setChild(null);} return $this; }

        /** @return \Doctrine\Common\Collections\Collection<int, EmergencyCall> */
        public function getEmergencyCalls() { return $this->emergencyCalls; }
        public function addEmergencyCall(EmergencyCall $e): self
        { if(!$this->emergencyCalls->contains($e)){ $this->emergencyCalls->add($e); $e->setChild($this);} return $this; }
        public function removeEmergencyCall(EmergencyCall $e): self
        { if($this->emergencyCalls->removeElement($e) && $e->getChild()===$this){ $e->setChild(null);} return $this; }

        /** @return \Doctrine\Common\Collections\Collection<int, GeoLocation> */
        public function getGeoLocations() { return $this->geoLocations; }
        public function addGeoLocation(GeoLocation $g): self
        { if(!$this->geoLocations->contains($g)){ $this->geoLocations->add($g); $g->setChild($this);} return $this; }
